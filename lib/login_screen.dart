...
import 'package:bike_taxi_app/screens/signup_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _tryLogin() async {
    ...
    final ok = await AuthService.login(_phoneCtl.text.trim(), _passCtl.text);
    setState(() { _loading = false; });
    if (ok) {
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => HomeScreen()));
    } else {
      setState(() { _error = 'رقم الهاتف أو كلمة المرور غير صحيحة'; });
    }
  }
